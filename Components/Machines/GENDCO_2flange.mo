...
model GENDCO_2flange
  ...
  extends
    TurbineGeneratorSSO.BaseModels.Machines.baseMachineMultidomain_2flange(
    XADIFD(start=efd0),
  ...
  OpenIPSL.Types.PerUnit PSIpp
    "Air-gap flux ";
  OpenIPSL.Types.PerUnit PSIpd(start = PSIpd0);
  OpenIPSL.Types.PerUnit PSIpq(start = PSIpd0);
...
protected
  ...
  parameter OpenIPSL.Types.PerUnit PSIq0=(-PSIppq0)
       - Xppq*iq0;
  parameter OpenIPSL.Types.PerUnit PSIpd0 = PSIppd0;
  parameter OpenIPSL.Types.PerUnit PSIpq0 = PSIppq0;
  // Constants
...
equation
  ...
  /////////////////////
  //still need der(PSId) and der(PSIq) equations to use for terminal voltage equations
  /////////////////////
  PSIpd = der(PSId);
  PSIpq = der(PSIq);
  Te = PSId*iq - PSIq*id;
  ...
  /////////////////////
  //include PSIpd and PSIpq terms in ud and uq
  /////////////////////
  ud = (-PSIq) - R_a*id + PSIpd;
  uq = PSId - R_a*iq + PSIpq;
  annotation (
